import { FormControl,InputLabel,Input,FormHelperText,AppBar, CssBaseline, Toolbar,Typography, Container, Alert,Avatar, Card,CardHeader, IconButton, CardMedia, CardActionArea, CardActions, CardContent, Modal, Box, FormGroup, TextField, FormLabel, Button, Checkbox} from "@mui/material"
import {CheckBox, Favorite, Home, LoginOutlined, MoreVert, PhotoCamera} from '@mui/icons-material'
...
<FormLabel color="success">Password</FormLabel>
  <TextField   onChange={(e)=>setPassword(e.target.value)}  placeholder="Hello" id="my-input" type={type} aria-describedby="my-helper-text" />
</FormControl>

<Button onClick={handleSubmit} startIcon={<LoginOutlined/>} variant="outlined" color="success" sx={{my:3, width: 100}}>
    Login
</Button>
<Checkbox width="25" onChange={(e)=>handle(e.target.checked)}>
             CHECK   
</Checkbox>
</FormGroup>
